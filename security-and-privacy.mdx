...
description: "SimpleX uses layered encryption: double ratchet E2E, TLS 1.2/1.3, NaCl crypto_box, and per-queue key signing. Audited by Trail of Bits in 2022 and 2024."
---
...
<Steps>
  <Step title="TLS 1.2/1.3 transport encryption (client ↔ server)">
  ...
  <Step title="Per-queue ephemeral key signatures authenticate every command">
