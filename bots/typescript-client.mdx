---
title: "SimpleX Chat TypeScript WebSocket Client Reference"
sidebarTitle: "TypeScript Client"
description: "The @simplex-chat/webrtc-client package: low-level TypeScript WebSocket client for the SimpleX CLI server with typed commands, responses, and events."
---
